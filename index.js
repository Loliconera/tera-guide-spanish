	...
	const translation = {
		...
		es: {
			...
			helpbody: [
				...
				["guide lNotice, enviar mensajes en el canal (Take Notice)", "PRMSG"],
			...
			lNotice: "Mensajes en el canal (Take Notice)",
			gNotice: "Mensajes en el canal (Party Chat)",
		...
		switch (page) {
			default:
				tmpData.push(
					...
					{ text: "<br>&#09;&#09;&#09;&#09;&#09;" },
					{ text: `<font color="${mod.settings.gNotice ? gcg : gcr}" size="+18">[${lang.gNotice}]</font>`, command: "guide gNotice;guide gui" }, { text: "&nbsp;&nbsp;" }, 
					{ text: "<br>&#09;&#09;&#09;&#09;&#09;" },
