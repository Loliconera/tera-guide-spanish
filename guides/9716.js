...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function boss_backattack_event() {
		...
		"h-716-91606-100":[
			...
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 58310, y: 127208, z: 2370, w: 2.00}, ownerName: "LASER ALEATORIO", message: "LASER ALEATORIO" },//3
			{ type: "spawn", sub_type: "item", id: 110684, sub_delay: 99999999, pos: { x: 58310, y: 127208, z: 2370, w: 2.00} },//3
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 57064, y: 127210, z: 2370, w: 1.00}, ownerName: "LASER ALEATORIO", message: "LASER ALEATORIO" },//4
			{ type: "spawn", sub_type: "item", id: 110684, sub_delay: 99999999, pos: { x: 57064, y: 127210, z: 2370, w: 1.00} }//4
		],
		"s-716-91606-1304-0": [{ type: "text", sub_type: "message", message_ES: "Laser Aleatorio", message: "Random Laser", },
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 5000, pos: { x: 57291, y: 129078, z: 2370, w: -1.00}, ownerName: "LASER ", message: "LASER ALEATORIO" },//1
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 5000, pos: { x: 58116, y: 129086, z: 2370, w: -2.06}, ownerName: "LASER", message: "LASER ALEATORIO" },//2
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 5000, pos: { x: 58119, y: 127632, z: 2370, w: 2.00}, ownerName: "LASER", message: "LASER ALEATORIO" },//3
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 5000, pos: { x: 57294, y: 127626, z: 2370, w: 1.00}, ownerName: "LASER", message: "LASER ALEATORIO" }//4
		],
		...
		"s-716-91606-1304-1": [{ type: "text", sub_type: "message", message_ES: "Iframe", message: "Dodge", delay: 500 }],
