...
module.exports = {
	...
	// 1 BOSS
	"s-735-1000-104-0": [{ "type": "text", "sub_type": "message", "message": "Front Clip", "message_RU": "Передний зажим", "message_ES": "Clip frontal (Stun)" }],	
	...
	"s-735-2000-105-0": [
		...
		{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 10, 278, 0, 4000] }
	],
	"s-735-2000-108-0": [
		{ "type": "text", "sub_type": "message", "message": "Back Swipe", "message_RU": "Откид назад", "message_ES": "Ataque hacia atrás" },
		{ "type": "spawn_func", "func": "vector", "args": [553, 0, 0, 240, 380, 0, 2000] },
		{ "type": "spawn_func", "func": "vector", "args": [553, 0, 0, 120, 380, 0, 2000] }
	],
	...
	"s-735-3000-116-0": [{ "type": "text", "sub_type": "message", "message": "Right Safe", "message_RU": "Справа сейф", "message_ES": "Derecha Segura" },
		{ "type": "spawn_func", "func": "point", "args": [553, 120, 250, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 130, 240, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 140, 230, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 150, 220, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 160, 210, 0, 3000] },
		{ "type": "spawn_func", "func": "vector", "args": [553, 170, 210, 180, 290, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 300, 250, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 310, 240, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 320, 230, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 330, 220, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 340, 210, 0, 3000] },
		{ "type": "spawn_func", "func": "vector", "args": [553, 350, 210, 0, 290, 0, 3000] }
	],
	"s-735-3000-117-0": [{ "type": "text", "sub_type": "message", "message": "Left Safe", "message_RU": "Слева сейф", "message_ES": "Izquierda Segura" },
		{ "type": "spawn_func", "func": "vector", "args": [553, 10, 210, 0, 290, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 20, 210, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 30, 220, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 40, 230, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 50, 240, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 60, 250, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 240, 250, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 230, 240, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 220, 230, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 210, 220, 0, 3000] },
		{ "type": "spawn_func", "func": "point", "args": [553, 200, 210, 0, 3000] },
		{ "type": "spawn_func", "func": "vector", "args": [553, 190, 210, 180, 290, 0, 3000] }
	],
	...
	"s-735-3000-305-0": [{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 8, 300, 0, 7000] }],
