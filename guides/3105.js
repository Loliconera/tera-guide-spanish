...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		// "h-3105-1000-50": [{ type: "text", sub_type: "message", message: "50%", message_ES: "50%" }],
		...
		"qb-3105-1000-31051005": [{ type: "text", sub_type: "message", message: "Bait (Storm)", message_ES: "Bait (Tormenta)" }], // get stun
		"qb-3105-1000-31051006": [{ type: "text", sub_type: "message", message: "Bait (Blades)", message_ES: "Bait (Cuchillas)" }], // cast ress
		"qb-3105-1000-31051007": [{ type: "text", sub_type: "message", message: "Puddles", message_ES: "Charcos" }], // <40%

		// Core mech <35%
		"qb-3105-1000-31051010": [{ type: "text", sub_type: "message", message: "Lasers + Wave", message_ES: "Láseres + Ola" }],
		"s-3105-1000-304-0": [ // red
			{ type: "text", sub_type: "message", message: "Dodge!", message_ES: "Iframe!", delay: 200 },
			// { type: "text", sub_type: "message", message: "Plague of Exhaustion", message_ES: "Чума/регресс", class_position: "priest", delay: 1000 },
			// { type: "text", sub_type: "message", message: "Regression", message_ES: "Регресс", class_position: "mystic", delay: 1000 },
		...
		"qb-3105-1000-31051011": [{ type: "text", sub_type: "message", message: "Lasers!", message_ES: "Láseres!" }], // <80%
