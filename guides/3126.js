...
let skills = {
	...
	// AOE лед (малый)
	"154-0": [{ "type": "text", "sub_type": "message", "message": "Ice Storm", "message_RU": "Ледяной шторм", "message_ES": "Tormenta de HIELO" }, { "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 8, 500, 0, 6000] }],
	// AOE огонь (малый)
