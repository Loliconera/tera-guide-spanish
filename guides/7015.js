...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-620-1000-107-0": [{ type: "text", sub_type: "message", message: "Attack (Back)", message_ES: "Ataque (hacia atras)" }],
		"s-620-1000-115-0": [{ type: "text", sub_type: "message", message: "Fireballs", message_ES: "Bolas de fuego" }],
		"s-620-1000-127-0": [
			{ type: "text", sub_type: "message", message: "Jump Back", message_ES: "Salto hacia atras" },
		...
		"s-620-1000-119-0": [{ type: "text", sub_type: "message", message: "Explosion | In", message_ES: "Explosion | Entrar" }],
		"s-620-1000-108-0": [{ type: "text", sub_type: "message", message: "Attack (Back)", message_ES: "Ataque (hacia atras)" }],
