...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-770-3000-1103-0": [{ type: "text", sub_type: "message", message: "Tail Slam", message_ES: "Coletazo" }],
		"s-770-3000-2103-0": [{ type: "text", sub_type: "message", message: "Tail Slam", message_ES: "Coletazo" }],
		"s-770-3000-1301-0": [{ type: "text", sub_type: "message", message: "FATE Avoid Circles", message_ES: "Círculos" }],
		"s-770-3000-2301-0": [{ type: "text", sub_type: "message", message: "FATE Avoid Circles", message_ES: "Círculos" }],
		"s-770-3000-1110-0": [{ type: "text", sub_type: "message", message: "Tail AOE (jump in front)", message_ES: "Coletazo АОЕ (salto frontal)" }],
		"s-770-3000-2110-0": [{ type: "text", sub_type: "message", message: "Tail AOE (jump in front)", message_ES: "Coletazo АОЕ (salto frontal)" }],
		"s-770-3000-1304-0": [{ type: "text", sub_type: "message", message: "Get Ready! (for in out mechanic)", message_ES: "¡Prepárate!" }],
		"s-770-3000-1303-0": [{ type: "text", sub_type: "message", message: "Get Ready! (for in out mechanic)", message_ES: "¡Prepárate!" }],
		"s-770-3000-1113-0": [
		...
		"s-770-3000-1318-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Consigue el CRÁNEO ROJO!" }],
		"s-770-3000-1317-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Consigue el CRÁNEO ROJO!" }],
		"s-770-3000-1319-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Consigue el CRÁNEO ROJO!" }],
		...
		"s-770-3000-1120-0": [{ type: "text", sub_type: "message", message: "Shooting skulls", message_ES: "Disparar cráneos" }],
		"s-770-3000-2120-0": [{ type: "text", sub_type: "message", message: "Shooting skulls", message_ES: "Disparar cráneos" }]
	};
};