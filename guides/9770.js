...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-770-3000-1103-0": [{ type: "text", sub_type: "message", message: "Tail Slam", message_ES: "Coletazo Atrás" }],
		"s-770-3000-2103-0": [{ type: "text", sub_type: "message", message: "Tail Slam", message_ES: "Coletazo Atrás" }],
		...
		"s-770-3000-1108-0": [{ type: "text", sub_type: "message", message: "Front Slam", message_ES: "Coletazo Frontal" }],
		"s-770-3000-2108-0": [{ type: "text", sub_type: "message", message: "Front Slam", message_ES: "Coletazo Frontal" }],
		"s-770-3000-1110-0": [{ type: "text", sub_type: "message", message: "Tail AOE (jump in front)", message_ES: "Coletazo АОЕ (Frente Seguro)" }],
		"s-770-3000-2110-0": [{ type: "text", sub_type: "message", message: "Tail AOE (jump in front)", message_ES: "Coletazo АОЕ (Frente Seguro)" }],
		...
		"s-770-3000-1319-0": [{ type: "text", sub_type: "message", message: "Get Red Skull!", message_ES: "¡Cráneo Rojo!" }],
