...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-770-3000-1110-0": [{ type: "text", sub_type: "message", message: "Tail AOE", message_ES: "Cola AoE" },
			{ type: "spawn", func: "semicircle", args: [26, 340, 553, 0, 0, 7, 630, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 4, 40, 338, 600, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, -4, 40, -338, 600, 0, 3000] }
		],
		"s-770-3000-2110-0": [{ type: "text", sub_type: "message", message: "Tail AOE", message_ES: "Cola AoE" },
			{ type: "spawn", func: "semicircle", args: [26, 340, 553, 0, 0, 7, 630, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 4, 40, 338, 600, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, -4, 40, -338, 600, 0, 3000] }
		],
		...
		"s-770-3000-1108-0": [{ type: "text", sub_type: "message", message: "Tail", message_ES: "Coletazo Frontal" },
			{ type: "spawn", func: "circle", args: [false, 553, -7, 280, 20, 155, 0, 2000] }
		],
		"s-770-3000-2108-0": [{ type: "text", sub_type: "message", message: "Tail", message_ES: "Coletazo Frontal" },
			{ type: "spawn", func: "circle", args: [false, 553, -7, 280, 20, 155, 0, 2000] }
		],
