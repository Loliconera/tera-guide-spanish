...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-770-3000-1301-0": [{ type: "text", sub_type: "message", message: "FATE Avoid Circles", message_ES: "Círculos (Iframe)" }],
		"s-770-3000-2301-0": [{ type: "text", sub_type: "message", message: "FATE Avoid Circles", message_ES: "Círculos (Iframe)" }],
		...
		"s-770-3000-1318-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Conseguir el cráneo!" }],
		"s-770-3000-1317-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Conseguir el cráneo!" }],
		"s-770-3000-1319-0": [{ type: "text", sub_type: "message", message: "Get red skull!", message_ES: "¡Conseguir el cráneo!" }],
		...
		"s-770-3000-1120-0": [{ type: "text", sub_type: "message", message: "Shooting skulls", message_ES: "Laser" }],
		"s-770-3000-2120-0": [{ type: "text", sub_type: "message", message: "Shooting skulls", message_ES: "Laser" }],
		"s-770-3000-1122-0": [{ type: "text", sub_type: "message", message: "Double shooting skulls", message_ES: "Laser Doble" }],
		"s-770-3000-2122-0": [{ type: "text", sub_type: "message", message: "Double shooting skulls", message_ES: "Laser Doble" }]
	};
};