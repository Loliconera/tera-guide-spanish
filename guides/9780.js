...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-780-1000-112-0": [{ type: "text", sub_type: "message", message: "Jump Forward", message_ES: "Salto adelante" }],
	...
	"s-780-2000-302-0": [{ type: "text", sub_type: "message", message: "AOE (Stand behind a stone)", message_ES: "AOE (pararse detrás de una piedra)" }],
    ...
    "s-780-3000-109-0": [{ type: "text", sub_type: "message", message: "Double Front Attack", message_ES: "Ataque Frontal Doble" }],
		"s-780-3000-110-0": [{ type: "text", sub_type: "message", message: "Wave Front", message_ES: "Ola Frontal" }],
		...
		"s-780-3000-113-0": [{ type: "text", sub_type: "message", message: "Pushback", message_ES: "Empujar" }],
    "s-780-3000-114-0": "s-780-3000-113-0",
		"s-780-3000-115-0": [{ type: "text", sub_type: "message", message: "Pushback", message_ES: "Empujar" }],
    "s-780-3000-301-0": [{ type: "text", sub_type: "message", message: "Get Out | Get In", message_ES: "Salir | Entrar" }],
		"s-780-3000-302-0": [{ type: "text", sub_type: "message", message: "Get In", message_ES: "Entrar" }],
