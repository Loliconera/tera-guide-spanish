...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3201-1000-107-0": [
			{ type: "text", sub_type: "message", message_ES: "Empujar Atrás (Lento)", message: "Back" },
		...
		"s-3201-1000-111-0": [{ type: "text", sub_type: "message", message_ES: "Spray Atrás (Lento)", message: "Back Wave" },
		...
		"s-3201-1000-112-1": [{ type: "text", sub_type: "message", delay: 1000, message_ES: "Iframe", message: "Iframe!" }],			
		"s-3201-1000-113-0": [
			{ type: "text", sub_type: "message", message_ES: "Salto (Lento)", message: "Jump (Slow)" },
			{ type: "text", sub_type: "message", delay: 1900, message_ES: "Iframe", message: "Iframe!" }
		],
		"s-3201-1000-118-0": [
			{ type: "text", sub_type: "message", message_ES: "Salto (Lento)", message: "Jump (Slow)" },
			{ type: "text", sub_type: "message", delay: 1900, message_ES: "Iframe", message: "Iframe!" },
		],
		"s-3201-1000-119-0": [{ type: "text", sub_type: "message", delay: 0, message_ES: "Spray FRONTAL + ATRÁS", message: "Back + Front" },
		...
		"s-3201-1000-132-1": [{ type: "text", sub_type: "message", delay: 500, message_ES: "Iframe", message: "Iframe!" }],		
		"s-3201-1000-133-0": [
			{ type: "text", sub_type: "message", delay: 0, message_ES: "Salto (Rapido)", message: "Jump (Fast)" },
		...
		"s-3201-1000-139-0": [{ type: "text", sub_type: "message", message_ES: "FRONTAL + ATRÁS (Rapido)", message: "Back + Front (Fast)" },
			{ type: "spawn", func: "vector", args: [553, 2, 0, 70, 800, 0, 2500] },	 //Adicionado
			{ type: "spawn", func: "vector", args: [553, 2, 0, 110, 800, 0, 2500] }, //Adicionado
			{ type: "spawn", func: "vector", args: [553, 2, 0, 250, 800, 0, 2500] }, //Adicionado
			{ type: "spawn", func: "vector", args: [553, 2, 0, 290, 800, 0, 2500] }	 //Adicionado
		...
		"s-3201-1000-148-0": [{ type: "text", sub_type: "message", message_ES: "Mano Derecha (Volando)", message: "Right Hand (Flying)" },
			{ type: "spawn", func: "circle", args: [false, 553, 20, 150, 10, 320, 0, 4000] }  //Adicionado
		],		
		"s-3201-1000-149-0": [{ type: "text", sub_type: "message", message_ES: "Mano Izquierda (Volando)", message: "Left Hand (Flying)" },
		...
		"s-3201-1000-311-0": [
			...
			{ type: "text", sub_type: "message", delay: 4300, message_ES: "Iframe", message: "Iframe!" }
		],
		"s-3201-1000-312-0": [
			{ type: "text", sub_type: "message", message_ES: "Repeler Full (Rápido)", message: "Repel Full (Fast)" },
			{ type: "text", sub_type: "message", delay: 2300, message_ES: "Iframe", message: "Iframe!" }
		],
		"s-3201-1000-313-0": [
		...
		"am-3201-320126-32010224": [
			...
			{ type: "text", delay: 52000, sub_type: "warning", message_ES: "[c=#ff6600]REAL[/c] Debuff en 5 Segundos", message: "True Debuff in 5 seconds" },
		...
		"am-3201-2000-32010220": [
			...
			{ type: "text", delay: 52000, sub_type: "warning", message_ES: "[c=#ba2a02]FAKE[/c] Debuff en 5 Segundos", message: "False Debuff in 5 seconds" },
			{ type: "event", delay: 80000, args: [
		...
		"s-3201-2000-230-0": [{ type: "text", sub_type: "message", message_ES: "AOE!!", message: "AOE!!" },
			{ type: "text", sub_type: "alert", delay: 1150, message_ES: "Iframe", message: "Iframe" }
		],
		...
		"s-3201-2000-235-0": [{ type: "text", sub_type: "message", message_ES: "Debuffs", message: "Debuffs" }],
		"s-3201-2000-236-0": [{ type: "text", sub_type: "message", message_ES: "Repeler a FRONTAL (Bait)", message: "Counter Attack (Bait)" },
