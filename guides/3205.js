...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	dispatch.hook("S_ABNORMALITY_BEGIN", dispatch._mod.majorPatchVersion >= 107 ? 5 : 4, event => {
		if (event.id === 32051007) {
			if (dispatch._mod.game.me.is(event.target)) {
				handlers.text({ sub_type: "notification", message: "Lasers on you", message_ES: "Láseres sobre ti" });
			} else {
				...
				if (member) {
					handlers.text({
						...
						message_ES: `Láseres Activados ${member.name}`
					});
				}
			}
		}
	...
	return {
		...
		"h-3205-1000-45": [{ type: "text", sub_type: "message", message: "45%", message_ES: "45%" }],
		...
		"s-3205-1000-114-0": [
			{ type: "text", sub_type: "message", message: "Back Laser", message_ES: "Láser atras" },
		...
		"s-3205-1000-107-0": [
			{ type: "text", sub_type: "message", message: "Spin | Back Laser", message_ES: "Girar | Láser atras" },
		...
		"qb-3205-1000-32051008": [{ type: "text", sub_type: "message", message: "Puddles", message_ES: "Charcos" }],
		...
		"qb-3205-1001-32051011": [
			{ type: "event", check_func: () => print_lasers, args: [
				{ type: "text", sub_type: "message", message: "Lasers!", message_ES: "¡Laseres!" },
