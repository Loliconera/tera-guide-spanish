...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3102-1000-1304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_ES: "¡Escudo!" }],
		"s-3102-1000-2304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_ES: "¡Escudo!" }],
