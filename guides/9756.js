...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-756-1001-107-0": [{ type: "text", sub_type: "alert", message: "Shot", message_ES: "Disparar" }],
		"s-756-403-106-0": [{ type: "text", sub_type: "alert", message: "Circle", message_ES: "Círculo" }],
		"s-756-1001-103-0": [{ type: "text", sub_type: "alert", message: "Tail", message_ES: "Cola" }],
		"s-756-1001-101-0": [{ type: "text", sub_type: "alert", message: "Hit", message_ES: "Golpear" }],
		"s-756-1001-112-0": [{ type: "text", sub_type: "message", message: "Rotate", message_ES: "Girar" }],
		"s-756-1001-113-0": "s-756-1001-112-0",
		"s-756-1001-111-0": [{ type: "text", sub_type: "message", message: "Flight", message_ES: "Volar" }],
		"s-756-1001-206-0": [{ type: "text", sub_type: "alert", message: "Pushback", message_ES: "Empujar" }],
		"qb-756-1001-456020": [{ type: "text", sub_type: "message", message: "Give stun", message_ES: "Dar Stun" }],
		...
		"s-756-1002-102-0": [{ type: "text", sub_type: "message", message: "Jump", message_ES: "Saltar" }],
		"s-756-1002-103-0": [{ type: "text", sub_type: "message", message: "Combo", message_ES: "Combo" }],
		"s-756-1002-104-0": [{ type: "text", sub_type: "message", message: "Shot (target)", message_ES: "Disparar -> (Objetivo)" }],
		"s-756-1002-107-0": [{ type: "text", sub_type: "message", message: "Many Pokes", message_ES: "Muchos Golpes" }],
		"s-756-1002-110-0": [{ type: "text", sub_type: "message", message: "Clap", message_ES: "Aplaudir" }],
		"s-756-1002-111-0": [{ type: "text", sub_type: "message", message: "Front | Jump Back", message_ES: "Aplaudir | Saltar Atrás" }],
		"s-756-1002-212-0": [{ type: "text", sub_type: "message", message: "Jump Back", message_ES: "Saltar Atrás" }],
		"s-756-1002-314-0": [{ type: "text", sub_type: "alert", message: "Lay Back", message_ES: "Salto Atrás" }],
		"s-756-1002-315-0": [{ type: "text", sub_type: "alert", message: "Lay Front", message_ES: "Salto Adelante" }],
		"s-756-1002-319-0": [{ type: "text", sub_type: "alert", message: "Spin", message_ES: "Girar" }],
		"s-756-1002-3110-0": [{ type: "text", sub_type: "message", message: "Breath", message_ES: "Aliento" }],
		"s-756-1002-3112-0": [{ type: "text", sub_type: "message", message: "AOE", message_ES: "AOE", delay: 4000 }],
		...
		"s-756-1003-104-0": [{ type: "text", sub_type: "message", message: "Clap", message_ES: "Aplaudir" }],
		"s-756-1003-105-0": [{ type: "text", sub_type: "message", message: "Front", message_ES: "Ataque Frontal" }],
		"s-756-1003-105-1": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás" }],
		"s-756-1003-107-0": [{ type: "text", sub_type: "message", message: "Swipe", message_ES: "Golpe Fuerte" }],
		"s-756-1003-108-0": [{ type: "text", sub_type: "message", message: "Swipe", message_ES: "Golpe Fuerte" }],
		"s-756-1003-109-0": [{ type: "text", sub_type: "message", message: "Breath (target)", message_ES: "Aliento -> (Objetivo)" }],
		"s-756-1003-111-0": [{ type: "text", sub_type: "message", message: "Leash (target)", message_ES: "Correa -> (Objetivo)" }],
		"s-756-1003-3104-0": [{ type: "text", sub_type: "message", message: "Cage", message_ES: "Jaula" }], // 456016
		"s-756-1003-3108-0": [{ type: "text", sub_type: "message", message: "Waves", message_ES: "Olas" }],
		"qb-756-1003-456015": [{ type: "text", sub_type: "message", message: "AOE", message_ES: "AOE" }], // 3103
		"qb-756-1003-456017": [{ type: "text", sub_type: "message", message: "Give Stun", message_ES: "Dar Stun" }] // 3102
	};
};