...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-454-1000-1107-0": [{ type: "text", sub_type: "message", message_ES: "Operación Tortuga", message: "Action Turtle" }],
		...
		"s-454-1000-1201-0": [{ type: "text", sub_type: "message", message_ES: "Placaje", message: "Body Slam!" }],
		"s-454-1000-1202-0": [{ type: "text", sub_type: "message", message_ES: "Invocación de Tortugas", message: "Turtles Summon" }],
		"s-454-1000-1203-0": [{ type: "text", sub_type: "message", message_ES: "Mareo, Salta", message: "Dizzy, Jump" }],
		"s-454-1000-1204-0": [{ type: "text", sub_type: "message", message_ES: "Recordatorio del Modo Tortuga", message: "Turtle Mode Reminder" }],
		"s-454-1000-1205-0": [{ type: "text", sub_type: "message", message_ES: "Escape de Tortuga", message: "Scape Turtle" }],
		"s-454-1000-1206-0": [{ type: "text", sub_type: "message", message_ES: "Atmósfera Ácida", message: "Acid Atmosphere" }],
		...
		"s-454-1000-3101-0": [{ type: "text", sub_type: "message", message_ES: "Destrucción de Rocas", message: "Rocks Destroyed" }],
		"s-454-1000-3102-0": [{ type: "text", sub_type: "message", message_ES: "Vómito Ácido Aleatorio", message: "Random Acid Puke" }], //
		"s-454-1000-3103-0": [{ type: "text", sub_type: "message", message_ES: "Derribar al Boss", message: "Knock Down Boss" }],
		"s-454-1000-3104-0": [{ type: "text", sub_type: "message", message_ES: "ROMPER ESCUDO!", message: "BREAKE SHIELD!" }],

		// 2 BOSS
		//"s-454-1001-1101-0": [{ type: "text", sub_type: "message", message_ES: "Ataque Frontal", message: "Frontal Attack" }],
		//"s-454-1001-1102-0": [{ type: "text", sub_type: "message", message_ES: "Voltereta Atrás (Rápida)", message: "Back Flip (Fast)" }],
		"s-454-1001-1104-0": [{ type: "text", sub_type: "message", message_ES: "Giro Frontal!", message: "Frontal Spin!" }],
		"s-454-1001-1105-0": [{ type: "text", sub_type: "message", message_ES: "Coletazo", message: "Tail" }],
		"s-454-1001-1108-0": [{ type: "text", sub_type: "message", message_ES: "Veneno Aleatorio", message: "Random Poison" }],
		"s-454-1001-1109-0": [{ type: "text", sub_type: "message", message_ES: "Jalar + Veneno", message: "Pull + Poison" },
			{ type: "text", sub_type: "message","delay": 1500, message_ES: "Destello", message: "Flash" }
		],
		"s-454-1001-1110-0": [{ type: "text", sub_type: "message", message_ES: "Giro! (Lento)", message: "Spin! (Slow)" }],
		"s-454-1001-1113-0": [{ type: "text", sub_type: "message", message_ES: "Charco de Slime", message: "Slime Puddle" }],
		"s-454-1001-1111-0": [{ type: "text", sub_type: "message", message_ES: "Ataque de Carga Giratorio", message: "Spin Lunge Attack" }],
		...
		"s-454-1001-3103-0": [{ type: "text", sub_type: "message", message_ES: "Derribar al Boss", message: "Knock Down Boss" }],
		...
		// 3BOSS
		"s-454-1002-1102-0": [{ type: "text", sub_type: "message", message_ES: "Golpe Frontal", message: "Frontal Attack" }],
		"s-454-1002-1103-0": [{ type: "text", sub_type: "message", message_ES: "Objetivo Aleatorio", message: "Random Target" }],
		"s-454-1002-1104-0": [{ type: "text", sub_type: "message", message_ES: "Dona (Entrar)", message: "Donut (In)" }],
		"s-454-1002-1107-0": [{ type: "text", sub_type: "message", message_ES: "Golpe Atrás (Rápido)", message: "Back Hit! (Fast)" }],
		"s-454-1002-1108-0": [{ type: "text", sub_type: "message", message_ES: "Golpe Atrás", message: "Back Hit" }],
		"s-454-1002-1112-0": [{ type: "text", sub_type: "message", message_ES: "Salto (Rápido)", message: "Jump (Fast)" }],
		"s-454-1002-1106-0": [{ type: "text", sub_type: "message", message_ES: "Ataque Izquierda", message: "Left Attack" }],
		"s-454-1002-1110-0": [{ type: "text", sub_type: "message", message_ES: "Barrido Engranajes", message: "Gear Sweep" }],
		...
		"s-454-1002-3105-0": [{ type: "text", sub_type: "message", message_ES: "Entrar", message: "Get In" }],
		"s-454-1002-3117-0": [{ type: "text", sub_type: "message", message_ES: "Entrar", message: "In" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 290, 0, 10000] },
			{ type: "text", sub_type: "message", message_ES: "Salir", message: "Out", delay: 3500 },
			{ type: "text", sub_type: "message", message_ES: "Entrar", message: "In", delay: 5500 }
		],
		"s-454-1002-3110-0": [{ type: "text", sub_type: "message", message_ES: "Pizza", message: "Pizza" },
		...
		"s-454-1002-3106-0": [{ type: "text", sub_type: "message", message_ES: "Corte Completado (Salir)", message: "Cut Completed (Get Out)" }],
		"s-454-1002-3113-0": [{ type: "text", sub_type: "message", message_ES: "ROMPER ESCUDO!", message: "BREAKE SHIELD!" }],
		"s-454-1002-3115-0": [{ type: "text", sub_type: "message", message_ES: "25% Modo Explosión", message: "25% Blast Mode" }],
		"s-454-1002-3119-0": [{ type: "text", sub_type: "message", message_ES: "Ataque de Ola (Ir Centro)", message: "Wave Attack (Go Center)" }],
		"qb-454-1002-454001": [{ type: "text", sub_type: "alert", message_ES: "Esfera Eléctrica", message: "Electric Ball" },
