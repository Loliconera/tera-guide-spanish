...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function first_fly_mech(skillid) {
		...
		if (!first_fifty) {
			if (prev_attack === 1113) {
				...
				handlers.text({ sub_type: "notification", message: "Pizza + Enraged", message_ES: "Pizza + Enfurecer" });
			} else {
				handlers.event(safe_unenraged_markers);
				handlers.text({ sub_type: "notification", message: "Pizza + Un enraged", message_ES: "Pizza + No Enfurecer" });
			}
		} else {
	...
	function secondboss_swipe_event(skillid) {
		...
		if (!second_fifty) {
			...
			const pattern3 = [{ type: "text", sub_type: "message", message: "Back - Front", message_ES: "Atras - Adelante" }];
			const pattern4 = [{ type: "text", sub_type: "message", message: "Front - Back", message_ES: "Adelante - Atras" }];
			...
			const pattern1 = [
				{ type: "text", sub_type: "notification", message: "Right (Double) - Front - Back", message_ES: "Derecha (Doble) - Adelante - Atras" },
				{ type: "spawn", func: "vector", args: [553, 360, 400, 180, 800, 0, 6000] },
				{ type: "spawn", func: "marker", args: [false, 60, 100, 4600, 2200, true, null] },
				{ type: "spawn", func: "marker", args: [false, 130, 100, 4600, 2200, true, null] },
				{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 20, 160, 4600, 2200] },
			...
			const pattern2 = [
				{ type: "text", sub_type: "notification", message: "Left (Double) - Back - Front", message_ES: "Izquierda (Doble) - Atras - Adelante" },
				{ type: "spawn", func: "vector", args: [553, 360, 400, 180, 800, 0, 6000] },
				{ type: "spawn", func: "marker", args: [false, 300, 100, 4600, 2200, true, null] },
				{ type: "spawn", func: "marker", args: [false, 230, 100, 4600, 2200, true, null] },
				{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 20, 160, 4600, 2200] },
	...
	function run_if_you_can(skillid) {
		...
		if (skillid === 1117) {
			handlers.event([{ type: "text", sub_type: "message", message: "Stun | Push Back", message_ES: "Stun | Empujar Atras" }]);
		}
		...
		if (skillid === 1105) {
			...
			handlers.event([{ type: "text", sub_type: "notification", message: msg, message_ES: msg_es }]);
	...
	function are_you_clever(skillid) {
		...
		if (skillid === 1102) {
			handlers.event([{ type: "text", sub_type: "message", message: "Rotate", message_ES: "Girar", delay: 900 }]);
		}
		...
		if (skillid === 1131 || skillid === 1132) {
			...
			msg_es = skillid === id ? "Pronto: SALIR | Donas (ENTRAR > SALIR)" : "Pronto: ENTRAR | Donas (SALIR > ENTRAR)";
	...
	return {
		...
		"s-985-1000-1303-0": [{ type: "text", sub_type: "message", message: "Spin", message_ES: "Girar" }],
		"s-985-1000-1304-0": [
		...
		"s-985-1000-1113-0": [
			{ type: "text", sub_type: "message", message: "Front | AoEs", message_ES: "Frontal | AOE" },
		...
		"s-985-1000-1115-0": [{ type: "text", sub_type: "message", delay: 2500, message_ES: "Iframe", message: "Dodge" }], // dodge circle
		"s-985-1000-1117-0": [{ type: "text", sub_type: "message", delay: 4500, message_ES: "Iframe", message: "Dodge" }], // dodge circles
		...
		"qb-985-1000-98103": [{ type: "text", sub_type: "message", message: "Lead circle to the stone", message_ES: "Lleva un círculo a la piedra" }],
		"qb-985-1000-98106": [{ type: "text", sub_type: "message", message: "Lead circles to the stone", message_ES: "Lleva los círculos a la piedra" }],
		"dm-0-0-9981005": [
		...
		"s-985-2000-1110-0": [{ type: "text", sub_type: "message", message: "Back Move", message_ES: "Mover Atras" }],
		"s-985-2000-1111-0": [{ type: "text", sub_type: "message", message: "360 attack", message_ES: "Ataque 360" }],
		"s-985-2000-1114-0": [{ type: "text", sub_type: "message", message: "Pull", message_ES: "Pull" }],
		"s-985-2000-1115-0": [{ type: "text", sub_type: "message", message: "Circles", message_ES: "Círculos" }],
		"s-985-2000-1115-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 150 }],
		"s-985-2000-1117-0": [{ type: "text", sub_type: "message", message: "Jump", message_ES: "Saltar" }],
		"s-985-2000-1106-0": [
			{ type: "func", func: () => second_swipes_remaining--, check_func: () => second_swipes_remaining > 0 },
			{ type: "text", sub_type: "message", message: "Back", message_ES: "Atras", check_func: () => !second_fifty || second_swipes_remaining !== 1 },
			{ type: "text", sub_type: "message", message: "Back - Front", message_ES: "Atras - Adelante", check_func: () => second_fifty && second_swipes_remaining === 1 },
			{ type: "spawn", func: "circle", args: [false, 553, 180, 340, 14, 270, 0, 2600] }
		],
		"s-985-2000-1108-0": [
			{ type: "func", func: () => second_swipes_remaining--, check_func: () => second_swipes_remaining > 0 },
			{ type: "text", sub_type: "message", message: "Front", message_ES: "Adelante", check_func: () => !second_fifty || second_swipes_remaining !== 1 },
			{ type: "text", sub_type: "message", message: "Front - Back", message_ES: "Adelante - Atras", check_func: () => second_fifty && second_swipes_remaining === 1 }
		],
		"s-985-2000-1130-0": [
			{ type: "func", func: () => second_swipes_remaining--, check_func: () => second_swipes_remaining > 0 },
		...
		"s-985-2000-1136-0": [{ type: "text", sub_type: "message", message: "Donut", message_ES: "Donas" }],
		"s-985-2000-1202-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_ES: "Lanzar al objetivo" }],
		"s-985-2000-1205-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_ES: "Lanzar al objetivo" }],
		"s-985-2000-1206-0": [{ type: "text", sub_type: "message", message: "Pike (Target)", message_ES: "Lanza (objetivo)" }],
		"s-985-2000-1302-0": [{ type: "text", sub_type: "message", message: "Bait (Target)", message_ES: "Cebo (objetivo)" }],
		"s-985-2000-1302-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 1600 }],
		"s-985-2000-1502-0": [
			{ type: "text", sub_type: "message", message: "AoE", message_ES: "AoE" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 80, 8, 390, 0, 3000] }
		],
		"s-985-2000-1503-0": [{ type: "text", sub_type: "message", message: "Target Lockon", message_ES: "Target Lockon" }],
		"s-985-2000-1504-0": [{ type: "text", sub_type: "message", message: "Mobs Summon", message_ES: "Mobs convocar" }],
		//
		...
		//
		"qb-985-4000-9981046": [{ type: "text", sub_type: "notification", message: "First: Debuffs (Closest)", message_ES: "Primero: Debuffs (Más cercano)" }], // Thank you... for this release...
		"qb-985-4000-9981047": [{ type: "text", sub_type: "notification", message: "First: Circles (Spread)", message_ES: "Primero: Círculos (Separarse)" }], // Beware the... red lightning...
		"qb-985-4000-9981048": [{ type: "text", sub_type: "notification", message: "First: Bombs (Gather + Cleanse)", message_ES: "Primero: Bombas (Juntos + Cleanse)" }], // Beware the mark... of Lakan...
		...
		//
		"s-985-3000-1116-0": [
			{ type: "text", sub_type: "message", message: "Donut (Out > In > Out)", message_ES: "Donas (SALIR > ENTRAR > SALIR)", check_func: () => !thirdboss_soul_world && thirdboss_eye },
			{ type: "text", sub_type: "message", message: "Donut (In > Out > In)", message_ES: "Donas (ENTRAR > SALIR > ENTRAR)", check_func: () => thirdboss_soul_world && thirdboss_eye },
			{ type: "text", sub_type: "message", message: "Donut x2 (Out > In > Out)", message_ES: "Donas x2 (SALIR > ENTRAR > SALIR)", check_func: () => !thirdboss_soul_world && thirdboss_fifty && !thirdboss_eye },
			{ type: "text", sub_type: "message", message: "Donut x2 (In > Out > In)", message_ES: "Donas x2 (ENTRAR > SALIR > ENTRAR)", check_func: () => thirdboss_soul_world && thirdboss_fifty && !thirdboss_eye },
		...
		"qb-985-3000-98131": [{ type: "text", sub_type: "message", message: "Range Check", message_ES: "Verificacion de rango" }],
		...
		"s-985-3000-1105-0": [
			...
			{ type: "text", sub_type: "message", message: "Push Back", message_ES: "Empujar Atras" }
		],
		"s-985-3000-1117-0": [{ type: "func", func: run_if_you_can, args: [1117] }],
		"qb-985-3000-98133": [
			{ type: "func", func: () => clever_mech_active = true },
			{ type: "text", sub_type: "message", message: "Cone | Rotate", message_ES: "Cono | Girar" }
		], // let's see just how clever you are...
		"qb-985-3000-98134": [
			{ type: "func", func: () => afriad_mech_active = true },
			{ type: "text", sub_type: "message", message: "Cone x2", message_ES: "Cono x2" }
		...
		"s-985-3000-1404-0": [{ type: "text", sub_type: "message", message: "Debuffs (Closest)", message_ES: "Debuffs (Más cercano)" }],
		"s-985-3000-1405-0": [{ type: "text", sub_type: "message", message: "Debuffs (Farthest)", message_ES: "Debuffs (Más lejano)" }],
		"s-985-3000-1301-0": [{ type: "text", sub_type: "message", message: "Bombs (Gather + Cleanse)", message_ES: "Bombas (Juntos + Cleanse)" }],
		"s-985-3000-1302-0": [{ type: "text", sub_type: "message", message: "Bombs (Gather + No cleanse)", message_ES: "Bombas (Juntos + No Cleanse)" }],
		"s-985-3000-3103-0": [{ type: "text", sub_type: "message", message: "Circles (Spread)", message_ES: "Círculos (Separarse)" }],
		"s-985-3000-3105-0": [{ type: "text", sub_type: "message", message: "Circles (Gather)", message_ES: "Círculos (Juntos)" }],
		"s-985-3000-1136-0": [{ type: "text", sub_type: "message", message: "Claw (Bait)", message_ES: "Garra (Cebo)" }],
		"s-985-3000-1144-0": [{ type: "text", sub_type: "message", message: "OUT", message_ES: "SALIR" }],
		"s-985-3000-1145-0": [{ type: "text", sub_type: "message", message: "IN", message_ES: "ENTRAR" }],
		"s-985-3000-1240-0": [
			{ type: "text", sub_type: "message", message: "Donuts", message_ES: "Donas" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 350, 0, 6000] }
		],
		"s-985-3000-1401-0": [
			{ type: "text", sub_type: "message", message: "Wave (Dodge) | Plague/Regress", message_ES: "Olas (Iframe) | Plague/Regress" },
			{ type: "text", sub_type: "message", message: "Puddles! (Spread)", message_ES: "Charcos! (Separarse)", delay: 1900 },
		...
		"s-985-3000-1402-0": [
			{ type: "text", sub_type: "message", message: "Wave (Dodge) | Sleep", message_ES: "Olas (Iframe) | Sueño" },
			{ type: "func", func: () => thirdboss_soul_world = false }
		],
		"s-985-3000-1701-0": [{ type: "text", sub_type: "message", message: "Back | Front", message_ES: "Atras | Frontal" }],
		//
		"s-985-3000-1129-0": [{ type: "text", sub_type: "message", message: "IN", message_ES: "ENTRAR" }],
		"s-985-3000-1113-0": [{ type: "text", sub_type: "message", message: "Bait", message_ES: "Cebo" }],
		"s-985-3000-1151-0": [{ type: "text", sub_type: "message", message: "Stun", message_ES: "Stun" }],
		"s-985-3000-1152-0": [{ type: "text", sub_type: "message", message: "Stun | Push Back", message_ES: "Stun | Empujar Atras" }],
		"s-985-3000-1152-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 1900 }],
		"s-985-3000-1138-0": [{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 250, 0, 6000] }], // begone
		"s-985-3000-2145-0": [
			{ type: "text", sub_type: "message", message: "IN", message_ES: "ENTRAR", check_func: () => !are_you_afraid_of_me_continue },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 10, 250, 0, 1500] },
			{ type: "text", sub_type: "message", message: "IN > OUT", message_ES: "ENTRAR > SALIR", check_func: () => are_you_afraid_of_me_continue },
		...
		"s-985-3000-2144-0": [
			{ type: "text", sub_type: "message", message: "OUT", message_ES: "SALIR", check_func: () => !are_you_afraid_of_me_continue },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 10, 250, 0, 1500] },
			{ type: "text", sub_type: "message", message: "OUT > IN", message_ES: "SALIR > ENTRAR", check_func: () => are_you_afraid_of_me_continue },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 10, 285, 2000, 2000], check_func: () => are_you_afraid_of_me_continue },
			{ type: "func", func: () => are_you_afraid_of_me_continue = false, check_func: () => are_you_afraid_of_me_continue, delay: 1000 }
		],
