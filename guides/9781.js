...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		//
		"dm-0-0-9781046": [{ type: "text", sub_type: "message", message: "First: (Debuffs) Closest", message_ES: "Primero: Debuff (Más cercano)" }], // Gracias... por esta versión...
		"dm-0-0-9781047": [{ type: "text", sub_type: "message", message: "First: (Círculos) Spread", message_ES: "Primero: Círculos (Separarse)" }], // Cuidado con el... rayo rojo...
		"dm-0-0-9781048": [{ type: "text", sub_type: "message", message: "First: (Bombas) Gather + Cleanse", message_ES: "Primero: Bombas (Reunirse + Cleanse)" }], // Cuidado con la marca... de Lakan...
		...
		"s-781-3000-1301-0": [{ type: "text", sub_type: "message", message: "(Bombas) Gather + Cleanse", message_ES: "Bombas (Reunir!) + Cleanse" }],
		"s-781-3000-1302-0": [{ type: "text", sub_type: "message", message: "(Bombas) Gather + No cleanse", message_ES: "Bombas (Reunir!) + No Cleanse" }],
		...
		"s-781-3000-1701-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_ES: "Ataque hacia atrás + Ataque frontal" }],
		//
