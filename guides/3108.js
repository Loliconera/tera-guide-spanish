...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3108-1000-109-0": [
			...
			{ type: "text", sub_type: "message", message: "Inward (In > Out)", message_ES: "Interior (Entrar > Salir)", check_func: () => !blue_sword, delay: 1000 },
			{ type: "text", sub_type: "message", message: "Unstable (In > In > Mid)", message_ES: "Inestable (Entrar > Entrar > Medio)", check_func: () => blue_sword, delay: 1000 },
		...
		"s-3108-1000-111-0": [
			...
			{ type: "text", sub_type: "message", message: "Outward (Out > In)", message_ES: "Exterior (Salir > Entrar)", check_func: () => !blue_sword, delay: 1000 },
			{ type: "text", sub_type: "message", message: "Unstable (Mid > In > Mid)", message_ES: "Inestable (Medio > Entrar > Medio)", check_func: () => blue_sword, delay: 1000 },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 180, 500, 0, 1500] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 0, 500, 0, 1500] },
		...
		// Pushback mech
		"ab-3108-1000-31083063-1": [{ type: "text", sub_type: "notification", message: "Stack 1", message_ES: "Apilar 1" }],
		"ab-3108-1000-31083063-2": [{ type: "text", sub_type: "notification", message: "Stack 2", message_ES: "Apilar 2" }],
		...
		// Cage mech
		"qb-3108-1000-31083002": [{ type: "text", sub_type: "message", message: "Cage", message_ES: "Jaula" }],
		"s-3108-1000-317-0": [
