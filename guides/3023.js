...
module.exports = {
	...
	"s-3023-1000-110-0": [
			{ "type": "text", "sub_type": "message", "message": "Stun", "message_RU": "Передний стан", "message_ES": "Stun" },
			{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 175, 10, 260, 0, 6000] }
	],
	"s-3023-1000-111-0": [
			{ "type": "text", "sub_type": "message", "message": "Left Slash", "message_RU": "Левая полоса", "message_ES": "Carril Izquierdo" },
	...
	"s-3023-1000-112-0": [
			{ "type": "text", "sub_type": "message", "message": "Right Slash", "message_RU": "Правая полоса", "message_ES": "Carril Derecho" },
	...
	"s-3023-1000-115-0": [
			{ "type": "text", "sub_type": "message", "message": "Back Attack", "message_RU": "Удар назад", "message_ES": "Ataque hacia atrás (CUIDADO)" },
	...
	// 2 BOSS
	"s-3023-2000-164-0": [{ "type": "text", "sub_type": "message", "message": "Counter Attack (bleed)", "message_RU": "Отпрыжка (Кровоток)", "message_ES": "Contraataque (Sangrar)" }],
	"s-3023-2000-166-0": [{ "type": "text", "sub_type": "message", "message": "Turn-back", "message_RU": "Оборот назад", "message_ES": "Ataque hacia atrás" }],
	"s-3023-2000-175-0": [
			{ "type": "text", "sub_type": "message", "message": "Incoming Stun", "message_RU": "Рёв", "message_ES": "Stun entrante" },
			{ "type": "text", "sub_type": "message", "delay": 1500, "message": "Dodge", "message_RU": "Эвейд", "message_ES": "Iframe" }
	],
	"s-3023-2000-178-0": [{ "type": "text", "sub_type": "message", "message": "Scratching (bleed)", "message_RU": "Крутилка (Кровоток)", "message_ES": "Scratching (Sangrar)" }],
	"s-3023-2000-181-0": [
			{ "type": "text", "sub_type": "message", "message": "Rock Throw", "message_RU": "Полоса вперед", "message_ES": "Lanzamiento de rocas" },
			{ "type": "spawn_func", "func": "vector", "args": [553, 90, 80, 10, 1000, 0, 4000] },
			{ "type": "spawn_func", "func": "vector", "args": [553, 270, 80, 350, 1000, 0, 4000] }
	],
	"s-3023-2000-182-0": [{ "type": "text", "sub_type": "message", "message": "Knockdown", "message_RU": "Опрокид", "message_ES": "Knockdown" }],
	"s-3023-2000-185-0": [
			{ "type": "text", "sub_type": "message", "message": "Big jump (Kaia's Shield)", "message_RU": "Прыжок (кайа)", "message_ES": "Gran salto (Kaia's Shield)", "class_position": "priest" },
			{ "type": "text", "sub_type": "message", "message": "Big jump (Thrall of Protection)", "message_RU": "Прыжок (кайа", "message_ES": "Gran salto (Thrall of Protection)", "class_position": "mystic" },
			{ "type": "text", "sub_type": "alert", "delay": 110000, "message": "Big jump soon...", "message_RU": "Скоро прыжок...", "message_ES": "Gran salto pronto...", "class_position": "heal" },
			{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 10, 500, 0, 6000] },
			{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 8, 750, 0, 6000] }
	],
	"s-3023-2000-202-0": [
			{ "type": "text", "sub_type": "message", "message": "Backstab", "message_RU": "Назад + Вперед", "message_ES": "Ataque hacia atrás + Adelante" },
			{ "type": "spawn_func", "func": "vector", "args": [553, 90, 80, 180, 500, 0, 3000] },
			{ "type": "spawn_func", "func": "vector", "args": [553, 270, 80, 180, 500, 0, 3000] }
	],
	"s-3023-2000-207-0": [{ "type": "text", "sub_type": "message", "message": "Phantom x5 (bleed)", "message_RU": "Прыжки x5 (Кровоток)", "message_ES": "Fantasma x5 (Sangrar)" }],
	"s-3023-2000-212-0": [{ "type": "text", "sub_type": "message", "message": "Flash (bleed)", "message_RU": "Байт (Кровоток)", "message_ES": "Flash (Sangrar)" }]
};