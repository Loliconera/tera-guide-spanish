...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3123-1000-104-0": [{ type: "text", sub_type: "message", message: "Random Jump", message_ES: "Saltar + Stun" }],
		"s-3123-1000-105-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás" }],
		"s-3123-1000-110-0": [
		...
		"s-3123-1000-3119-0": [ // red inside
			{ type: "text", sub_type: "message", message: "OUT (red)", message_ES: "SALIR", check_func: () => debuff === 1, delay: 500 },
			{ type: "text", sub_type: "message", message: "IN (blue)", message_ES: "ENTRAR", check_func: () => debuff === 2, delay: 500 },
		...
		"s-3123-1000-3220-0": [ // blue inside
			{ type: "text", sub_type: "message", message: "IN (blue)", message_ES: "ENTRAR", check_func: () => debuff === 1, delay: 500 },
			{ type: "text", sub_type: "message", message: "OUT (red)", message_ES: "SALIR", check_func: () => debuff === 2, delay: 500 },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 270, 0, 4000] },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 650, 0, 4000] }
		],
		...
		"s-3123-2000-164-0": [{ type: "text", sub_type: "message", message: "Counter Attack (bleed)", message_ES: "Salto Atrás (sangrar)" }],
		"s-3123-2000-166-0": [{ type: "text", sub_type: "message", message: "Turn-back", message_ES: "Ataque Atrás" }],
		"s-3123-2000-175-0": [
		...
		"s-3123-2000-178-0": [{ type: "text", sub_type: "message", message: "Scratching (bleed)", message_ES: "Garras Giratoria (sangrar)" }],
		"s-3123-2000-181-0": [
		...
		"s-3123-2000-214-0": [{ type: "text", sub_type: "message", message: "5x Rock", message_ES: "5x Roca" }],

		"s-3123-2000-182-0": [{ type: "text", sub_type: "message", message: "Knockdown", message_ES: "Derribar" }],
		"s-3123-2000-185-0": [
		...
		"s-3123-2000-207-0": [{ type: "text", sub_type: "message", message: "Phantom x5 (bleed)", message_ES: "Fantasma x5 (sangrar)" }],
		"s-3123-2000-212-0": [{ type: "text", sub_type: "message", message: "Flash (bleed)", message_ES: "Flash (sangrar)" }]
	};
};