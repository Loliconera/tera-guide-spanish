...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3034-1000-104-0": [{ type: "text", sub_type: "message", message: "Front Clip", message_ES: "Clip Frontal (Stun)" }],
		...
		"s-3034-1000-307-0": [{ type: "text", sub_type: "message", message: "Pull", message_ES: "Pull" }],
		"s-3034-1000-309-0": [
			{ type: "text", sub_type: "message", message: "Four Missile", message_ES: "Lanzamiento de 4 misiles" },
