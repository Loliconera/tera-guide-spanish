...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function thirdboss_sattack_event(skillid) {
		...
		if ([1160, 1170, 1180, 1190].includes(skillid) && boss_seventy) { // <70%
			if (mech_reverse) {
				...
				handlers.text({ sub_type: "message", delay: 4500, message: "Out", message_ES: "Salir" });
			} else {
				handlers.text({ sub_type: "message", message: "Triple-S | In", message_ES: "Triple-S | Entrar" });
				handlers.text({ sub_type: "message", delay: 4500, message: "In", message_ES: "Entrar" });
			}
	...
	return {
		...
		"qb-3034-1000-3034101": [{ type: "text", sub_type: "message", message: "Pizza", message_ES: "Pizza" }],
		"qb-3034-1000-3034102": [{ type: "text", sub_type: "message", message: "AOE! Jump", message_ES: "¡AOE! Saltar!!" }],
		"s-3034-1000-104-0": [{ type: "text", sub_type: "message", message: "Front Clip", message_ES: "Ataque Frontal (Stun)" }],
		"s-3034-1000-108-0": [{ type: "text", sub_type: "message", message: "Get Out", message_ES: "Salir" }], // крутилка
		"s-3034-1000-111-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_ES: "Ataque Atrás + Adelante" }],
		"s-3034-1000-112-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás" }],
		"s-3034-1001-205-0": [{ type: "text", sub_type: "message", message: "Wind (Kaia)", message_ES: "Viento (Kaia)" }],
		...
		"s-3034-1000-306-0": [{ type: "text", sub_type: "message", message: "Bombs", message_ES: "Bombas" }],
		"s-3034-1000-307-0": [{ type: "text", sub_type: "message", message: "Pull", message_ES: "Jalar" }],
		"s-3034-1000-309-0": [
		...
		"h-3034-3000-70": [
			{ type: "text", sub_type: "message", message: "70%", message_ES: "70%" },
		...
		"s-3034-3000-126-0": [{ type: "text", sub_type: "message", message: "Front | Back", message_ES: "Ataque Frontal | Ataque Atrás" }],
		"s-3034-3000-127-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás" }],
		"s-3034-3000-128-0": [
