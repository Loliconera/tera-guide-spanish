...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"h-3040-1000-35": [{ type: "text", sub_type: "message", message: "35%", message_ES: "35%" }],
		...
		"s-3040-1000-112-0": [{ type: "text", sub_type: "message", message: "Wave Forward", message_ES: "Empuje Frontal" },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 70, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 290, 500, 0, 2000] }
		],
		"s-3040-1000-114-0": [{ type: "text", sub_type: "message", message: "Inner + Outer AOEs", message_ES: "Interno + Externo AOEs" }],
		"s-3040-1000-116-0": [
		...
		"s-3040-1000-119-0": [{ type: "text", sub_type: "message", message: "Two Strikes", message_ES: "Dos Ataques" }],
		"s-3040-1000-120-0": [
			{ type: "text", sub_type: "message", message: "Two Strikes + Stun (AOE)", message_ES: "Dos Ataques + Stun (АОЕ)" },
			{ type: "text", sub_type: "message", message: "Stun (AOE)", message_ES: "Iframe", delay: 2000 },
			{ type: "spawn", func: "circle", args: [true, 553, 180, -100, 10, 700, 0, 2500], delay: 1500 }
		],
		"s-3040-1000-123-0": [{ type: "text", sub_type: "message", message: "Spin", message_ES: "Ataque Giratorio" }],
		"s-3040-1000-125-0": [{ type: "text", sub_type: "message", message: "Stun (Tank)", message_ES: "Stun (Tank)" }],
		"s-3040-1000-127-0": [
		...
		"s-3040-1000-156-0": [{ type: "text", sub_type: "message", message: "Get Skulls", message_ES: "Cráneos" }],
		"s-3040-1000-157-0": [{ type: "text", sub_type: "message", message: "Gather!", message_ES: "¡Reunirse!", delay: 2000 }],
		"s-3040-1000-158-0": [{ type: "text", sub_type: "message", message: "Gather!", message_ES: "¡Reunirse!", delay: 5000 }],
		"s-3040-1000-159-0": [
