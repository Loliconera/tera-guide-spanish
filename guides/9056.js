...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		// Boss 3
		"ab-456-1003-905607": [
		{ type: "text", sub_type: "message", message: "Plague of Exhaustion", message_ES: "Cleanse + Plague", "class_position": "priest" },
		{ type: "text", sub_type: "message", message: "Regression", message_ES: "Cleanse + Regression", "class_position": "mystic" }],
		...
		"s-456-1003-105-1": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque hacia atras" }],
		...
		"dm-0-0-905624": [{ type: "text", sub_type: "alert", message: "Wall Change", message_ES: "Cambio de Sello", delay: 1000 }], // green
		"dm-0-0-905625": [{ type: "text", sub_type: "alert", message: "Wall Change", message_ES: "Cambio de Sello", delay: 1000 }], // red
		"dm-0-0-905626": [{ type: "text", sub_type: "alert", message: "Wall Change", message_ES: "Cambio de Sello", delay: 1000 }], // purple
	};
};