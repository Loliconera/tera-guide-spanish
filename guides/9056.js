...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-456-1002-314-0": [{ type: "text", sub_type: "alert", message: "Lay Back", message_ES: "Salto Atrás" }],
		"s-456-1002-315-0": [{ type: "text", sub_type: "alert", message: "Lay Front", message_ES: "Salto Adelante" }],
