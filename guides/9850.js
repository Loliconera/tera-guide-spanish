...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function first_fly_mech(skillid) {
		...
		if (!first_fifty) {
			if (prev_attack === 1113) {
				...
				handlers.text({ sub_type: "notification", message: "Pizza + Enraged", message_ES: "Pizza + Enraged" });
			} else {
				handlers.event(safe_unenraged_markers);
				handlers.text({ sub_type: "notification", message: "Pizza + Un enraged", message_ES: "Pizza + Sin enrage" });
			}
		} else {
	...
	function debuff_removed() {
		if (next_debuff != 0) {
			handlers.text({
				...
				message_ES: `Siguiente Debuff (Donas): 1, ${next_debuff}`,
				speech: false
			});
		}
	...
	return {
		...
		"ns-850-6002": [{ type: "text", sub_type: "message", message: "Shard", message_ES: "Pilon" }],
		...
		"s-850-6000-1104-0": [
			{ type: "text", sub_type: "message", message: "Impact", message_ES: "Golpear + Balanceo" },
		...
		"s-850-6000-1107-0": [{ type: "text", sub_type: "message", message: "Boms", message_ES: "Una bomba" }],
		"s-850-6000-1109-0": [
			{ type: "text", sub_type: "message", message: "1 strike", message_ES: "1 strike" },
		...
		"s-850-6000-1110-0": [
			{ type: "text", sub_type: "message", message: "2 strikes", message_ES: "2 strike" },
			{ type: "spawn", func: "semicircle", args: [-160, 105, 553, 0, 0, null, 550, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, -160, 550, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 105, 550, 0, 3000] },
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 3000, distance: 350, offset: 2.6, ownerName: "SAFE SPOT", message: "SAFE" },
		...
		"s-850-6000-1111-0": [{ type: "text", sub_type: "message", message: "Left kick", message_ES: "Patada izquierda" }],
		"s-850-6000-1112-0": [{ type: "text", sub_type: "message", message: "Right kick", message_ES: "Patada derecha" }],
		"s-850-6000-1113-0": [{ type: "text", sub_type: "message", message: "Laser", message_ES: "Láser" }],
		"s-850-6000-1113-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe" }],
		"s-850-6000-1133-0": [
		...
		"s-850-7000-1136-0": [{ type: "text", sub_type: "message", message: "Claw", message_ES: "Garras" }],
		"s-850-7000-1110-0": [{ type: "text", sub_type: "message", message: "Claw", message_ES: "Garras" }],
		"s-850-7000-1129-0": [{ type: "text", sub_type: "message", message: "IN", message_ES: "ENTRAR" }],
		"s-850-7000-1130-0": [
			{ type: "text", sub_type: "message", message: "Shield Strike", message_ES: "Golpe de escudo" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 130, 0, 270, 0, 2500] }
		],
		"s-850-7000-1132-0": [
			{ type: "text", sub_type: "message", message: "AOE Shield", message_ES: "¡Escudo AOE!" },
		...
		"s-850-7000-1135-0": [{ type: "text", sub_type: "message", message: "IN", message_ES: "ENTRAR" }],
		"s-850-7000-1240-0": [
			{ type: "text", sub_type: "message", message: "Donuts", message_ES: "Donas!" },
		...
		"s-850-7000-1401-0": [{ type: "text", sub_type: "message", message: "Plague/Regress", message_ES: "Plague/Regress!!" }],
		"s-850-7000-1402-0": [{ type: "text", sub_type: "message", message: "Sleep", message_ES: "Dormir!!" }],
		"s-850-7000-1701-0": [{ type: "text", sub_type: "message", message: "Back + front", message_ES: "Atrás + frente" }],
		"s-850-7000-1113-0": [{ type: "text", sub_type: "message", message: "Bait", message_ES: "Bait" }],
		"s-850-7000-1151-0": [{ type: "text", sub_type: "message", message: "Stun", message_ES: "Stun" }],
		"s-850-7000-1152-0": [
			{ type: "text", sub_type: "message", message: "Stun + Back", message_ES: "Stun + Atrás" },
		...
		"s-850-7000-1901-0": [ // normal world
			{ type: "text", sub_type: "notification", message: "Debuffs Closest", message_ES: "Debuffs (Medio)" },
			{ type: "func", func: seventh_spawn_tables, args: [true] }
		],
		"s-850-7000-1902-0": [ // soul world
			{ type: "text", sub_type: "notification", message: "Debuffs Farthest", message_ES: "Debuffs (Lejos)" },
		...
		"s-850-7000-1905-0": [ // normal world
			{ type: "text", sub_type: "notification", message: "Spread", message_ES: "Círculos (separar!)" },
			{ type: "func", func: seventh_spawn_tables, args: [true] }
		],
		"s-850-7000-1906-0": [ // soul world
			{ type: "text", sub_type: "notification", message: "Gather", message_ES: "Círculos (Reunir!)" },
			{ type: "func", func: seventh_spawn_tables, args: [false] }
		],
		"s-850-7000-1144-0": [
		...
		"s-850-88516-1103-0": [{ type: "text", sub_type: "message", message: "Front", message_ES: "Frontal" }],
		"s-850-88516-1104-0": [{ type: "text", sub_type: "message", message: "Stun (AoE)", message_ES: "Stun (AOE)" }],
		"s-850-88516-1105-0": [
			{ type: "text", sub_type: "message", message: "Lasers", message_ES: "Láseres" },
			{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 2700 }
		],
		"s-850-88516-1106-0": [
			{ type: "text", sub_type: "message", message: "Push", message_ES: "Empujar" },
			{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 1400 },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 0, 220, 0, 2000] }
		],
		"s-850-88516-1107-0": [{ type: "text", sub_type: "message", message: "Disc Left", message_ES: "Disco Izquierda" }],
		"s-850-88516-1108-0": [{ type: "text", sub_type: "message", message: "Disc Right", message_ES: "Disco Derecha" }],
		"s-850-88516-1109-0": [{ type: "text", sub_type: "message", message: "Spin", message_ES: "Girar" }],
		"s-850-88516-1301-0": [{ type: "text", sub_type: "message", message: "Target", message_ES: "Objetivo" }],
		"s-850-88516-1303-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Atrás" }],
		"dm-0-0-9885238": [{ type: "text", sub_type: "message", message: "Clones", message_ES: "Clones" }],
		...
		"s-850-8504000-1303-0": [{ type: "text", sub_type: "message", message: "Spin", message_ES: "Girar" }],
		...
		"s-850-8504000-1114-0": [
			{ type: "text", sub_type: "message", message: "Bait on res", message_ES: "Bait en res" },
		...
		"s-850-8504000-1115-0": [{ type: "text", sub_type: "message", delay: 2500, message_ES: "Iframe", message: "Dodge" }], // dodge circle
		"s-850-8504000-1117-0": [{ type: "text", sub_type: "message", delay: 4500, message_ES: "Iframe", message: "Dodge" }], // dodge circles
		...
		"qb-850-8504000-98103": [{ type: "text", sub_type: "message", message: "Lead circle to the stone", message_ES: "Conduce el círculo a la piedra" }],
		"qb-850-8504000-98106": [{ type: "text", sub_type: "message", message: "Lead circles to the stone", message_ES: "Conduce los círculos a la piedra" }],
		"dm-0-0-9981005": [
		...
		"s-850-10000-1103-0": [{ type: "text", sub_type: "message", message_ES: "Ataque frontal", message: "Frontal Attack" }],
		"s-850-10000-1205-0": [{ type: "text", sub_type: "message", message_ES: "Teleport", message: "Teleport" }],
		"s-850-10000-1102-0": [{ type: "text", sub_type: "message", message_ES: "ENTRAR > SALIR", message: "In > Out" }],
		"s-850-10000-1113-0": [{ type: "text", sub_type: "message", message_ES: "Mano izquierda", message: "Left Hand Attack" }],
		"s-850-10000-1105-0": [{ type: "text", sub_type: "message", message_ES: "Mano derecha", message: "Right Hand Attack" }],
		"s-850-10000-1112-0": [{ type: "func", func: debuff_event, args: [true, 0] }],
		"s-850-10000-1108-0": [{ type: "text", sub_type: "message", message_ES: "Ataque (Objetivo)", message: "Target Attack" }],
		"s-850-10000-1114-0": [{ type: "text", sub_type: "message", message_ES: "Golpear atrás", message: "Back Attack" }],
		"s-850-10000-1115-0": [{ type: "text", sub_type: "message", message_ES: "Cola", message: "Tail" }],
		"s-850-10000-1111-0": [{ type: "text", sub_type: "message", message_ES: "Cola adelante", message: "Frontal Attack" }],
		"s-850-10000-1109-0": [{ type: "text", sub_type: "message", message_ES: "AOE (Objetivo)", message: "AoE Target" }],
		"s-850-10000-1104-0": [{ type: "text", sub_type: "message", message_ES: "Pisotón", message: "Stomp" }],
		"s-850-10000-1107-0": [{ type: "text", sub_type: "message", message_ES: "Láser", message: "Laser Attack" },
		...
		"s-850-10000-1106-0": [{ type: "text", sub_type: "message", message_ES: "Una bomba (Objetivo)", message: "Target Bomb" }],
		"s-850-10000-1204-0": [{ type: "text", sub_type: "message", message_ES: "Gran AOE (correr)", message: "Big AoE (Run)" },
