...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function sword_event(skillid, ent) {
		if ([101, 102].includes(skillid)) {
			...
			if (sword_counter >= 2 && skillid == 101) {
				if (sword_counter == 2) handlers.event({ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque atras" });
				if (sword_counter == 3) {
					handlers.event({ type: "text", sub_type: "message", message: "Double", message_ES: "Doble" });
					swipes_active = true;
		...
		if ([103, 105, 106, 108].includes(skillid) && !secondboss && !swipes_active) {
			...
			if (smash_counter >= 4 && skillid == 108) {
				handlers.event({ type: "text", sub_type: "message", message: "Back X2-X3", message_ES: "Ataque atras X2-X3" });
				smash_counter = 0;
			}
		...
		if ([111].includes(skillid) && [105, 108].includes(last_smash) && secondboss) {
			...
			if (last_smash == 105) {
				reverse = true;
				handlers.text({ sub_type: "notification", message: "X4 REVERSE", message_ES: "X4 REVERSE" });
			}
			if (last_smash == 108) {
				reverse = false;
				handlers.text({ sub_type: "notification", message: "X4 NORMAL", message_ES: "X4 NORMAL" });
			}
			last_smash = 0;
		}
	}
	...
	function tripleattack_event() {
		...
		triples_timeout = dispatch.setTimeout(() => {
			handlers.text({ sub_type: "notification", message: "Triples Soon!", message_ES: "¡Triples pronto!" });
		}, 80000);
	}
	...
	return {
		...
		"s-3111-2000-1117-0": [
			{ type: "text", class_position: "tank", sub_type: "message", message: "Tank Buster", message_ES: "Tank" },
			{ type: "text", sub_type: "message", message: "BUSTER SHOT!!!", message_ES: "¡¡¡Disparo!!!", check_func: () => is_hp_49 || firstpizza }
		],
		"s-3111-2000-1303-0": [{ type: "text", sub_type: "message", message: "Drill Attack", message_ES: "Крутилка" }],
		"s-3111-2000-2115-0": [
			{ type: "text", sub_type: "message", message: "TOGETHER!!!", message_ES: "¡¡¡Juntos!!!" },
		...
		"s-3111-2000-1811-0": [{ type: "text", sub_type: "message", message: "SILENCE", message_ES: "SILENCIO" }],
		"s-3111-2000-1807-0": [{ type: "func", func: cage_one }],
		"s-3111-2000-1808-0": [
			{ type: "func", func: cage_two },
			{ type: "text", sub_type: "message", delay: 3000, message: "Cleanse", message_ES: "Cleanse" }
		],
		"s-3111-2000-1809-0": [
			{ type: "func", func: cage_two },
			{ type: "text", sub_type: "message", delay: 3000, message: "Cleanse", message_ES: "Cleanse" }
		...
		"s-3111-675-675-0": [{ type: "text", sub_type: "message", message: "RESBAIT!!!", message_ES: "RESBAIT!!!" }],
		...
		"s-3111-2000-1305-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe" }],
		...
		"s-3111-1000-1114-0": [
			{ type: "text", sub_type: "message", message: "Target Attack", message_ES: "Ataque al objetivo" },
