...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-720-1000-1117-0": [{ type: "text", sub_type: "message", message: "In > Out", message_ES: "Entrar > Salir" }],
		"s-720-1000-1116-0": [{ type: "text", sub_type: "message", message: "Out > In", message_ES: "Salir > Entrar" }],
		"s-720-1000-1109-0": [{ type: "text", sub_type: "message", message: "Back Attack", message_ES: "Ataque Atrás" }],
		"s-720-1000-1300-0": [{ type: "text", sub_type: "message", delay: 600, message: "Dodge!", message_ES: "Iframe!" }],
		...
		"s-720-2000-1104-0": [{ type: "text", sub_type: "message", message: "Random Jump", message_ES: "Salto aleatorio" }],
		"s-720-2000-1105-0": [{ type: "text", sub_type: "message", message: "Back Attack", message_ES: "Ataque Atrás" }],
		"s-720-2000-1106-0": [
			{ type: "text", sub_type: "message", message: "Spin Attack", message_ES: "Girar" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 320, 0, 3500] }
		],
		"s-720-2000-1108-0": [{ type: "text", sub_type: "message", message: "Target Swing", message_ES: "Objetivo" }],
		"s-720-2000-1110-0": [
		...
		"s-720-2000-3116-0": [{ type: "text", sub_type: "message", message: "Circles", message_ES: "Círculos" }],
		"s-720-2000-3119-0": [{ type: "text", sub_type: "message", message: "Red: Out safe", message_ES: "Rojo: SALIR" }],
		"s-720-2000-3220-0": [{ type: "text", sub_type: "message", message: "Blue: In safe", message_ES: "Azul: ENTRAR" }],
		//
		...
		"s-720-3000-1107-0": [{ type: "text", sub_type: "message", message: "Random Jump", message_ES: "Salto aleatorio" }],
		...
		"s-720-3000-1113-0": [{ type: "text", sub_type: "message", message: "Front | Back Stun", message_ES: "Ataque Frontal | Stun Atrás" }],
		"s-720-3000-1115-0": [{ type: "text", sub_type: "message", message: "Spin Attack", message_ES: "Girar" }],
		"s-720-3000-1120-0": [{ type: "text", sub_type: "message", message: "Energy Beam (Slow)", message_ES: "Rayo de Energia (Lento)" }],
		"s-720-3000-1204-0": [{ type: "text", sub_type: "message", message: "Energy Beam (Fast)", message_ES: "Rayo de Energia (Rápido)" }],
		"s-720-3000-1206-0": [{ type: "text", sub_type: "message", message: "Orbs", message_ES: "Orbes" }],
		"s-720-3000-1309-0": [{ type: "text", sub_type: "message", message: "AoE", message_ES: "AoE" }],
		"s-720-3000-1310-0": [{ type: "text", sub_type: "message", message: "Puddles", message_ES: "Charcos (Olas)" }],
		...
		"s-720-3000-1315-0": [{ type: "text", sub_type: "message", message: "Pushback", message_ES: "Empujar Atrás (Kaia)" }],
		"s-720-3000-1400-0": [{ type: "text", sub_type: "message", message: "Clones: Beam", message_ES: "Clones: Olas" }],
		"s-720-3000-1401-0": [{ type: "text", sub_type: "message", message: "Clones: Spin", message_ES: "Clones: Girar" }],
