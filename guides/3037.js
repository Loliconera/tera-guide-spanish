...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3037-1000-1108-0": [
			{ type: "text", sub_type: "message", message: "Back Throw", message_ES: "Tirar Martillo Atrás (Stun)" },
		...
		"s-3037-1000-1116-0": [
			...
			{ type: "spawn", func: "circle", args: [false, 912, 0, 0, 10, 290, 100, 2000] }
		],
		"s-3037-1000-1116-1": [
			{ type: "text", sub_type: "message", message: "Out > In", message_ES: "Salir > Entrar" },
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 10, 290, 100, 4000] }
		],
		...
		"s-3037-2000-1138-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_ES: "Iframe" }], // Knockup (Bait)
		...
		"s-3037-2000-2115-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe" }], // Knockup
