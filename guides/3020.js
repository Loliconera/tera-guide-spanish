...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3020-2200-108-0": [
			{ type: "text", sub_type: "message", message: "Front Stun", message_ES: "Stun frontal" },
		...
		"s-3020-2200-128-0": [{ type: "text", sub_type: "message", message: "Uppercut (Knockup)", message_ES: "Corte superior (Knock up)" }],
		"s-3020-2200-129-0": [
			{ type: "text", sub_type: "message", message: "Hammer Toss ~ Skull", message_ES: "Lanzar el martillo ~ Calavera" },
			{ type: "spawn", func: "vector", args: [553, 90, 100, 0, 500, 200, 2000] },
			{ type: "spawn", func: "vector", args: [553, 270, 100, 0, 500, 200, 2000] }
		],
		//"s-3020-2200-131-0": [{ type: "text", sub_type: "message", message: "Jump", message_ES: "Saltar" }],
		"s-3020-2200-133-1": [
