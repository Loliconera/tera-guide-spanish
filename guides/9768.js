...
module.exports = (dispatch, handlers, guide, lang) => {
  ...
  let thirdboss_combo_count = 0;
	...
	return {
		...
		"s-768-1000-102-0": [{ type: "text", sub_type: "message", message: "Turn Attack", message_ES: "Ataque por turnos" }],
		"s-768-1000-106-0": [{ type: "text", sub_type: "message", message: "Three Combo", message_ES: "Combo Triple" }],
		"s-768-1000-107-0": [{ type: "text", sub_type: "message", message: "Front Combo", message_ES: "Combo Frontal" }],
		"s-768-1000-301-0": [{ type: "text", sub_type: "message", message: "Wave Front", message_ES: "Ola Frontal" }],
		"s-768-1000-304-0": [{ type: "text", sub_type: "message", message: "Strike (Target)", message_ES: "Disparar (Objetivo)" }],
		"s-768-1000-304-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 700 }],
		"s-768-1000-305-0": [{ type: "text", sub_type: "message", message: "8 explosions", message_ES: "8 explosiones" }],
		"s-768-1000-306-0": [{ type: "text", sub_type: "message", message: "Stones", message_ES: "Pilares" }], // 306 -> 307
		...
		"s-768-2000-101-0": [{ type: "text", sub_type: "message", message: "Fireball", message_ES: "Bola de fuego" }],
		"s-768-2000-102-0": [{ type: "text", sub_type: "message", message: "Drain", message_ES: "Drenar" }],
		"s-768-2000-103-0": [{ type: "text", sub_type: "message", message: "Explosion", message_ES: "Explosión" }],
		"s-768-2000-104-0": [{ type: "text", sub_type: "message", message: "Dark Frame", message_ES: "Marco oscuro" }],
		"s-768-2000-110-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_ES: "Ataque Frontal" }],
		"s-768-2000-111-0": [{ type: "text", sub_type: "message", message: "360", message_ES: "Girar" }], // 114 -> 111
		"s-768-2000-112-0": [{ type: "text", sub_type: "message", message: "Back Attack", message_ES: "Ataque Atrás" }],
		"s-768-2000-117-0": [{ type: "text", sub_type: "message", message: "Laser (Target)", message_ES: "Láser (Objetivo)" }],
		"s-768-2000-117-2": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 600 }],
		"s-768-2000-118-0": [{ type: "text", sub_type: "message", message: "Laser", message_ES: "Láser" }],
		"s-768-2000-307-0": [{ type: "text", sub_type: "message", message: "Donut", message_ES: "Dona" }],
		"s-768-2000-501-0": [{ type: "text", sub_type: "message", message: "Charging", message_ES: "Cargando" }],
		...
		//
		"s-768-3000-110-0": [{ type: "text", sub_type: "message", message: "Back Move", message_ES: "Atrás Mover" }],
		"s-768-3000-111-0": [{ type: "text", sub_type: "message", message: "360 attack", message_ES: "Girar" }],
		"s-768-3000-114-0": [{ type: "text", sub_type: "message", message: "Pull", message_ES: "Pull" }], // 114 -> 111
		"s-768-3000-115-0": [{ type: "text", sub_type: "message", message: "Circles", message_ES: "Circulos" }], // 202/205 -> 115
		"s-768-3000-115-1": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", delay: 150 }],
		"s-768-3000-117-0": [{ type: "text", sub_type: "message", message: "Jump", message_ES: "Saltar" }], // 503 -> 117
		...
		"s-768-3000-136-0": [{ type: "text", sub_type: "message", message: "Donut", message_ES: "Dona" }], // 135 -> 136
		"s-768-3000-202-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_ES: "Lanzar -> Objetivo" }], // 503 -> 201 -> 202
		"s-768-3000-205-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_ES: "Lanzar -> Objetivo" }], // 503 -> 117 -> 203 -> 204 -> 205
		...
		"s-768-3000-503-0": [{ type: "text", sub_type: "message", message: "Target Lockon", message_ES: "Bloqueo de objetivo" }], // qb 468050 -> 503
		"s-768-3000-504-0": [{ type: "text", sub_type: "message", message: "Mobs Summon", message_ES: "Invocar mobs" }],
