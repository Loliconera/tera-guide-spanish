...
module.exports = (dispatch, handlers, guide, lang) => {
		...
		if (skillid == 116) { // Haymaker
			if (in_bait) {
				...
				handlers.text({
					...
					message_ES: "Puñetazo | Patada hacia atras"
				});
			}
		}
	}
	...
	return {
		...
		//"s-3203-1000-101-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Punch", message_ES: "Серия Patadaов" }],
		"s-3203-1000-113-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Roundhouse Kick", message_ES: "Patada Giratoria" }],
		...
		"s-3203-1000-153-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Two Kicks", message_ES: "Dos Patadas" }], // 153 108
		//"s-3203-1000-108-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Floor Punch", message_ES: "Patada о землю" }],
		//"s-3203-1000-127-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Many Kicks", message_ES: "Несколько Patadaов" }],
		...
		//"s-3203-1000-154-0": [{ type: "text", sub_type: "message", message: "Jumping Kick", message_ES: "Patada в прыжке" }], // 154 310 116
		// 310 116
		"s-3203-1000-310-0": [ 
			{ type: "text", sub_type: "message", message: "Back Flip | Haymaker", message_ES: "Salto hacia atras | Puñetazo" },
		...
		"s-3203-1000-131-0": [{ type: "text", sub_type: "message", message: "Rhythmic Blows", message_ES: "Golpes Ritmicos" }], // 131 132 133
		"s-3203-1000-146-0": [
			{ type: "text", sub_type: "message", message: "Back Kick", message_ES: "Patada hacia atras" }, // 116 146
		...
		"s-3203-1000-124-0": [{ type: "text", sub_type: "message", message: "Kick", message_ES: "Patada" }], // 305 124
		"s-3203-1000-125-0": [{ type: "text", sub_type: "message", message: "Kick", message_ES: "Patada" }],
		...
		"s-3203-1000-155-0": [{ type: "text", sub_type: "message", delay: 400, message: "Dodge", message_ES: "Iframe" }],

		// Stun 142 148 129
		"s-3203-1000-142-0": [{ type: "text", sub_type: "message", message: "Stun | Back Wave", message_ES: "Stun | Olas hacia tras" }],
		"s-3203-1000-148-0": [{ type: "spawn", func: "circle", args: [true, 912, 0, -10, 12, 300, 0, 3000] }],
		"s-3203-1000-129-0": [
			{ type: "text", sub_type: "message", message: "Back Wave", message_ES: "Olas hacia tras" },
		...
		// Jump 143-0 143-1
		"s-3203-1000-143-0": [{ type: "text", sub_type: "message", message: "Jump (Stun)", message_ES: "Saltar (Stun)" }],
		...
		"s-3203-1000-152-0": [
			{ type: "text", sub_type: "message", message: "Explosion (Stun)", message_ES: "Explosion (Stun)" },
			{ type: "spawn", func: "circle", args: [true, 912, 0, 0, 8, 460, 0, 2500] },
			{ type: "text", sub_type: "alert", delay: 58000, message: "Explosion soon...", message_ES: "Explosion pronto..." }
		],
		"s-3203-1000-135-0": [
			{ type: "text", sub_type: "message", message: "Explosion (Stun)", message_ES: "Explosion (Stun)" },
			{ type: "spawn", func: "circle", args: [true, 912, 0, 0, 8, 460, 0, 2500] },
