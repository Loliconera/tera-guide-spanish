...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-427-42701-1110-0": [{ type: "text", sub_type: "message", message_ES: "Salto + AoE (Grande)", message: "Jump + AoE (Big)" },
	...
	//	"s-427-42701-1204-0": [{ type: "text", sub_type: "message", message_ES: "Bait", message: "Bait" }],
	//	"s-427-42701-2204-0": [{ type: "text", sub_type: "message", message_ES: "Bait", message: "Bait" }],
	//	"s-427-42701-1204-0": [{ type: "text", sub_type: "message", message_ES: "Salto Stun", message: "Jump Stun" }],
	//	"s-427-42701-2204-0": [{ type: "text", sub_type: "message", message_ES: "Salto Stun", message: "Jump Stun" }],
		...
		"qb-427-42702-427030": [{ type: "text", sub_type: "message", message_ES: "Matar Minions Azules", message: "Kill Blue Minions" }],
		"dm-0-0-9027005": [{ type: "text", sub_type: "message", message_ES: "Matar Minions Rojos", message: "Kill Red Minions" }],
		...
		"s-427-2001-1103-0": [{ type: "text", sub_type: "message", message_ES: "AOE", message: "AOE" }],
		"s-427-2001-1111-0": [{ type: "text", sub_type: "message", message_ES: "Prisión + AoE", message: "Cage + AoE" }],
		...
		// Fase 2
		//"s-427-2007-1103-0": [{ type: "text", sub_type: "message", message_ES: "Español", message: "English" }],
		//"s-427-2007-2103-0": [{ type: "text", sub_type: "message", message_ES: "Español", message: "English" }],
		...
		"s-427-2007-1109-0": [{ type: "text", sub_type: "message", message_ES: "AoE Objetivo (Grande)", message: "AoE Target (Big)" }],
		"s-427-2007-1107-0": [{ type: "text", sub_type: "message", message_ES: "Ataque Láser", message: "Laser Attack" }],
		"s-427-2007-1106-0": [{ type: "text", sub_type: "message", message_ES: "Objetivo AoE (Pequeño)", message: "Target AoE (Small)" }],
