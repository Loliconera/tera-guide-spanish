...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {		
		...
		"qb-427-42702-427030": [{ type: "text", sub_type: "notification", message_ES: "Matar Minions [c=#05a0fa]Azules[/c]", message: "Kill [c=#05a0fa]Blue[/c] Minions" }],//69%
		"dm-0-0-9027004": [{ type: "text", sub_type: "notification", message_ES: "Matar Minions [c=#05a0fa]Azules[/c]", message: "Kill [c=#05a0fa]Blue[/c] Minions" }],	//18%
		"dm-0-0-9027005": [{ type: "text", sub_type: "notification", message_ES: "Matar Minions [c=#e82331]Rojos[/c]", message: "Kill [c=#e82331]Red[/c] Minions" }],	//18%
