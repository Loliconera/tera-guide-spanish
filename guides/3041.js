...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3041-1000-122-0": [ // 122 - 123 - 124
			{ type: "text", sub_type: "message", message: "Throw (Target)", message_ES: "Lanzar al > (Objetivo)" },
		...
		"s-3041-2000-144-0": [
			{ type: "text", sub_type: "message", message: "Right X-Swipe", message_ES: "Arrastre Derecho (Cruz)" },
			{ type: "spawn", func: "vector", args: [912, 315, 700, 130, 1200, 0, 3000] }
		],
		"s-3041-2000-145-0": [
			{ type: "text", sub_type: "message", message: "Left X-Swipe", message_ES: "Arrastre Izquierdo (Cruz)" },
		...
		"s-3041-2000-151-0": [
			{ type: "text", sub_type: "message", message: "Throws Combo | Stun", message_ES: "Lanzar Combo | Stun" },
