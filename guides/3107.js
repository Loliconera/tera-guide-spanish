...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	const mech_messages = {
		"out": { message: "Out", message_ES: "Salir" },
		"in": { message: "In", message_ES: "Entrar" },
		"wave": { message: "Wave", message_ES: "Ola" },
		"unk": { message: "?", message_ES: "?" }
	};
	...
	function s_attacks_event(side) {
		...
		if (side == "left") {
			handlers.text({ sub_type: "message", delay: delay, message: "Right Safe", message_ES: "Derecha Segura" });
		}

		if (side == "right") {
			handlers.text({ sub_type: "message", delay: delay, message: "Left Safe", message_ES: "Izquierda Segura" });
		}

		if (s_attacks_notice && boss_seventy) { // <70%
			if (mech_reverse) {
				handlers.text({ sub_type: "message", message: "Triple-S | Out", message_ES: "Triple-S | Salir" });
				handlers.text({ sub_type: "notification", delay: 4500, message: "Out", message_ES: "Salir" });
			} else {
				handlers.text({ sub_type: "message", message: "Triple-S | In", message_ES: "Triple-S | Entrar" });
				handlers.text({ sub_type: "notification", delay: 4500, message: "In", message_ES: "Entrar" });
			}
	...
	function wave_attacks_event() {
		...
		const mech_message = {
			0: [ // left safe
				// { type: "text", sub_type: "notification", message: "Left Safe", message_ES: "Izquierda Segura" },
			...
			1: [ // right safe
				// { type: "text", sub_type: "notification", message: "Right Safe", message_ES: "Derecha Segura" },
				{ type: "spawn", func: "vector", args: [912, 360, 400, 180, 800, 0, 4500] },
	...
	dispatch.hook("S_DUNGEON_EVENT_GAGE", 2, event => {
		if (event.name === "ScanProgress") {
			if (event.value === 85) {
				handlers.text({ sub_type: "message", message: "Drain Soon", message_ES: "Pronto Drenaje" });
			}
		}
	});
	...
	return {
		...
		"h-3107-3000-70": [
			{ type: "text", sub_type: "notification", message: "70%", message_ES: "70%" },
		...
		// Basic attacks
		"s-3107-3000-1110-0": [{ type: "text", sub_type: "message", message: "Front", message_ES: "Ataque Frontal" }],
		"s-3107-3000-4000-0": "s-3107-3000-1110-0",
		"s-3107-3000-1310-0": [{ type: "text", sub_type: "message", message: "Front | Back", message_ES: "Ataque Frontal | Ataque Atrás" }],
		"s-3107-3000-1321-0": "s-3107-3000-1310-0",
		"s-3107-3000-1115-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás" }],
		...
		"s-3107-3000-2102-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Dodge", message_ES: "Iframe" }],
		...
		"s-3107-3000-1313-0": [{ type: "text", sub_type: "message", message: "Shield!", message_ES: "¡ESCUDO!" }],
		...
		"ab-3107-3000-310700020": [{ type: "text", sub_type: "notification", message: "Lasers Soon", message_ES: "Láser pronto" }],
		...
		// Radar mech
		"qb-3107-3000-31075430": [{ type: "text", sub_type: "message", message: "!!! Radar !!!", message_ES: "!!! Radar !!!" }],
		"s-3107-3000-1118-0": [
