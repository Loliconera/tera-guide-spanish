...
module.exports.general = {
	...
	es: {
		...
		helpbody: [
			...
			["guia verbose id, enviar mensajes para dungeons especificas por ID", "PRMSG"],
			["guia spawnObject id, generación de objetos y marcadores para dungeons especificas", "PRMSG"],
		...
		green: "Verde",
		settings: "Ajustes",
		spawnObject: "Generación de Marcadores",
